...
def test_get_product_name():
    ...
    name_20m = packaging.get_product_name(
        reference_name, secondary_name, pixel_spacing=20.0, slc=False
    )
    name_80m = packaging.get_product_name(
        reference_name, secondary_name, pixel_spacing=80, slc=False
    )
